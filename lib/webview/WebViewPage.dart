...
class _WebVieweState extends State<WebViewPage> {
      ...
      body: Builder(builder: (BuildContext context) {
        return WebView(
          ...
          navigationDelegate: (NavigationRequest request) {
            ...
            //checks if user needs to open other app
            if(request.url.contains('fb://') ||
              ...
              //prevent webview from loading url
              //becaus eits lunching in other app
  ...
  _launchURL(url) async {
    print("Launching URL from Webview : $url");
